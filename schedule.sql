...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Ноя 22 2022 г., 09:51
...
(1, 'Практика', 1, '2022-07-21', '2022-08-27'),
(2, 'П-16-11В', 5, '2022-07-21', '2022-08-27'),
(3, 'П-18-11Б', 3, '2016-09-01', '2020-06-06'),
(4, 'П-16-39Б', 5, '2016-09-01', '2020-06-06'),
(5, 'ИС 20-12Б', 4, '2018-05-04', '2022-05-04');
...
(1, 'Web-программирование', 1, 90, 1),
(2, 'Основы объекты ориентированного программирования', 1, 106, 1),
(3, 'Вёрстка', 1, 52, 1),
(4, 'Электроснабжение', 3, 36, 1);
...
(2, 'Иванов', 'Иван', 'Иваныч', 'Awe4ka', '1234', 1, '1992-11-03', 3, 1),
(4, 'Грановский', 'Сергей', 'Леонович', 'Aboba', '$2y$10$JrK4GUcvXd10I4XuWmmjKOFh/Li/.d70uEIm//BjHcTzg7u.JFJsq', 1, '2004-06-07', 3, 1);
...
ALTER TABLE `schedule`
  ...
  ADD CONSTRAINT `schedule_ibfk_2` FOREIGN KEY (`lesson_num_id`) REFERENCES `lesson_num` (`lesson_num_id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  ADD CONSTRAINT `schedule_ibfk_3` FOREIGN KEY (`day_id`) REFERENCES `day` (`day_id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
...
ALTER TABLE `teacher`
  ...
  ADD CONSTRAINT `teacher_ibfk_3` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`) ON DELETE RESTRICT ON UPDATE RESTRICT;
...
ALTER TABLE `user`
  ...
  ADD CONSTRAINT `user_ibfk_3` FOREIGN KEY (`role_id`) REFERENCES `role` (`role_id`) ON DELETE RESTRICT ON UPDATE RESTRICT;
COMMIT;
